...
// read 
pamfletRoute.post('/create', tokenMiddleware, upload.single('pamflet'), PamfletController.create);
...
// update 
pamfletRoute.patch('/update/:id', tokenMiddleware, upload.single('pamflet'), PamfletController.update);
